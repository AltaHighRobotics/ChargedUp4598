...
public class ArmLowerPositionCommand extends CommandBase {
  /** Creates a new ArmLowerPositionCommand. */
  private ArmAndClawSub m_armAndClawSub;
  public ArmLowerPositionCommand(ArmAndClawSub armAndClawSub) {
