...
public class CenterMiddlePlaceCommand extends CommandBase {
  ...
  public CenterMiddlePlaceCommand(XboxController driveController, DriveTrainSub driveTrainSub, ArmAndClawSub armAndClawSub, Vision vision) {
