...
public class LowerLeftPlaceCommand extends CommandBase {
  ...
  public LowerLeftPlaceCommand(DriveTrainSub driveTrainSub, ArmAndClawSub armAndClawSub, Vision vision) {
    m_driveTrainSub = driveTrainSub;
    m_armAndClawSub = armAndClawSub;
    m_vision = vision;

    autoAlignment = new AutoAlignment(m_driveTrainSub, m_vision, Constants.LEFT_VERTICAL_SETPOINT, Constants.LEFT_HORIZONTAL_SETPOINT);
