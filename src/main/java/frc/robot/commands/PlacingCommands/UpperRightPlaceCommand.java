...
public class UpperRightPlaceCommand extends CommandBase {
  ...
  public UpperRightPlaceCommand(DriveTrainSub driveTrainSub, ArmAndClawSub armAndClawSub, Vision vision) {
