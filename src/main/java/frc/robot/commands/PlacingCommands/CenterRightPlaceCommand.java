...
public class CenterRightPlaceCommand extends CommandBase {
  ...
  public CenterRightPlaceCommand(XboxController driveController, DriveTrainSub driveTrainSub, ArmAndClawSub armAndClawSub, Vision vision) {
